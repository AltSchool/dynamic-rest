...
def create_fixture():
    ...
    horses = [
        {"name": "Seabiscuit", "origin": "LA"},
        {"name": "Secretariat", "origin": "Kentucky"},
    ]

    zebras = [
        {"name": "Ralph", "origin": "new york"},
        {"name": "Ted", "origin": "africa"},
    ]
    ...
    parts = [
        {"car": 1, "name": "wheel", "country": 1},
        {"car": 1, "name": "tire", "country": 2},
    ]
