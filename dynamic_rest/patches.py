...
def patch_prefetch_one_level():
    """
    Patch prefetch_one_level() to fix Django bug.
    ...
    def prefetch_one_level(instances, prefetcher, lookup, level):
        ...
        if additional_lookups:
            rel_qs._prefetch_related_lookups = []  # pylint: disable=protected-access
        ...
        for obj in instances:
            ...
            if single:
                ...
                if as_attr:
                    ...
                    qs._result_cache = vals  # pylint: disable=protected-access
                    qs._prefetch_done = True  # pylint: disable=protected-access
                    obj._prefetched_objects_cache[  # pylint: disable=protected-access
                        cache_name
                    ] = qs
        return all_related_objects, additional_lookups

    # apply the patch
    from django.db.models import query  # pylint: disable=import-outside-toplevel
